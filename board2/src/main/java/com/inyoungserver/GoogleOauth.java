...
public class GoogleOauth extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String[] GoogleInfo = OauthService.verifyAndGetGoogleJson(token);
		String googleEmail = GoogleInfo[0];
		String name = GoogleInfo[1];
		String id = GoogleInfo[2];
		
		String snsUser = "google" + id;
