...
public class BbsDDL {
	public static boolean insert(BbsDTO dto) {
		...
		try {
			...
			String sql = "insert into bbsfree"
	...
	public static Vector <BbsDTO> getSelectAll(){
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String sql = "select * from bbsfree";
	...
	public static Vector <BbsDTO> getSelectLimit(int limitNum, int listNum){
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String sql = "select * from bbsfree order by num asc limit ? , ?";
		Vector <BbsDTO> data = new Vector <> ();
		try {
			conn = new DBConnect().getConn();
			ps = conn.prepareStatement(sql);
	...
	public static Vector <BbsDTO> getSelectByNum(int num){
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		
		String sql = "select * from bbsfree where num = ?";
	...
	public static boolean DbCount(int num) {
		...
		String sql = "update bbsfree set count = count + 1 where num = ?";
	...
	public static boolean DeleteTextFree(int num) {
		...
		String sql1 = "delete from bbsfree where num = ?";
		...
		int flag2 = 0;
		String sql2 = "delete from comment where bbsnum = 3 and num = ?";
	...
	public static boolean ModifiedText(BbsDTO dto) {
		Connection conn = null;
		PreparedStatement ps = null;
		int flag = 0;
		String sql = "update bbsfree set content = ?, title = ? where num = ?";
	...
	public static boolean updateLike(int textnum, int Like) {
		...
		String sql = "update bbsfree set likes = ? where num = ?";
